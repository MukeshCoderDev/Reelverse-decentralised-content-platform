  ...
  static getUserFriendlyMessage(error: WalletError): string {
    switch (error.type) {
      case WalletErrorType.USER_REJECTED:
        return 'Connection was cancelled. Please click "Connect" in your wallet when prompted.';
      
      case WalletErrorType.WALLET_NOT_FOUND:
        return 'MetaMask not detected. Please install MetaMask extension and refresh the page.';
      ...
      default:
        return 'Connection failed. Make sure MetaMask is unlocked and try again.';
    }
  }
}